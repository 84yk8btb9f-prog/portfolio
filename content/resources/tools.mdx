...
**Supabase** — database, auth, storage, realtime, edge functions. One platform that covers the whole backend. Free tier is generous, paid tier is fair. My default for everything.
