...
| Instead of | Use | Why |
|---|---|---|
| Read / cat | `ctx_read` | Session-cached; re-reads cost ~13 tokens |
...
[lean-ctx](https://github.com/nicholasgasior/lean-ctx) is one implementation of this pattern — an MCP server that wraps the four operations above with caching and compression.
